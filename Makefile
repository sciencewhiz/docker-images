...
build/cross: build/base
	...
	cd raspbian-cross-ubuntu && \
	    docker build -t ${DOCKER_USER}/raspbian-cross-ubuntu:2025-${UBUNTU} -f Dockerfile.2025 --build-arg UBUNTU=${UBUNTU} --build-arg TYPE=base . && \
	    docker build -t ${DOCKER_USER}/raspbian-cross-ubuntu:2027-${UBUNTU} -f Dockerfile.2027 --build-arg UBUNTU=${UBUNTU} --build-arg TYPE=base .
	cd aarch64-cross-ubuntu && \
	    docker build -t ${DOCKER_USER}/aarch64-cross-ubuntu:2025-${UBUNTU} -f Dockerfile.2025 --build-arg UBUNTU=${UBUNTU} --build-arg TYPE=base . && \
	    docker build -t ${DOCKER_USER}/aarch64-cross-ubuntu:2027-${UBUNTU} -f Dockerfile.2027 --build-arg UBUNTU=${UBUNTU} --build-arg TYPE=base .
...
build/minimal-cross: build/minimal-base
	...
	cd raspbian-cross-ubuntu && \
	    docker build -t ${DOCKER_USER}/raspbian-cross-ubuntu-minimal:2025-${UBUNTU} -f Dockerfile.2025 --build-arg UBUNTU=${UBUNTU} --build-arg TYPE=minimal-base . && \
	    docker build -t ${DOCKER_USER}/raspbian-cross-ubuntu-minimal:2027-${UBUNTU} -f Dockerfile.2027 --build-arg UBUNTU=${UBUNTU} --build-arg TYPE=minimal-base .
	cd aarch64-cross-ubuntu && \
	    docker build -t ${DOCKER_USER}/aarch64-cross-ubuntu-minimal:2025-${UBUNTU} -f Dockerfile.2025 --build-arg UBUNTU=${UBUNTU} --build-arg TYPE=minimal-base . && \
	    docker build -t ${DOCKER_USER}/aarch64-cross-ubuntu-minimal:2027-${UBUNTU} -f Dockerfile.2027 --build-arg UBUNTU=${UBUNTU} --build-arg TYPE=minimal-base .
...
push/cross: push/base
	...
	docker push ${DOCKER_USER}/raspbian-cross-ubuntu:2025-${UBUNTU}
	docker push ${DOCKER_USER}/raspbian-cross-ubuntu:2027-${UBUNTU}
	docker push ${DOCKER_USER}/aarch64-cross-ubuntu:2025-${UBUNTU}
	docker push ${DOCKER_USER}/aarch64-cross-ubuntu:2027-${UBUNTU}
...
push/minimal-cross: push/minimal-base
	...
	docker push ${DOCKER_USER}/raspbian-cross-ubuntu-minimal:2025-${UBUNTU}
	docker push ${DOCKER_USER}/aarch64-cross-ubuntu-minimal:2027-${UBUNTU}
...
save/minimal-cross:
	...
	docker save ${DOCKER_USER}/raspbian-cross-ubuntu-minimal:2025-${UBUNTU} | gzip > raspbian.tar.gz
	docker save ${DOCKER_USER}/raspbian-cross-ubuntu-minimal:2027-${UBUNTU} | gzip > raspbian.tar.gz
	docker save ${DOCKER_USER}/aarch64-cross-ubuntu-minimal:2025-${UBUNTU} | gzip > aarch64.tar.gz
	docker save ${DOCKER_USER}/aarch64-cross-ubuntu-minimal:2027-${UBUNTU} | gzip > aarch64.tar.gz
